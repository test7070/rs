        ...
        <script type="text/javascript">
            ...
            function btnOk() {    
                ...
                if (t_noa.length == 0 || t_noa == "AUTO")
                    q_gtnoa(q_name, replaceAll(q_getPara('sys.key_ordcpro') + (t_date.length == 0 ? q_date() : t_date), '/', ''));
                else
                    wrServer(t_noa);
            }
        ...
        <div id="dmain">
            ...
            <div class="dbbm">
                <table class="tbbm"  id="tbbm">
                    ...
                    <tr>
                        <td><span> </span><a id="lblTypeano" class="lbl"> </a></td>
                        <td><input id="txtTypeano"  type="text" class="txt c1"/></td>
                    </tr>
                    <tr>
